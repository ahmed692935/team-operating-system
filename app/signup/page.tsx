...
import { Eye, EyeOff, ArrowRight, ArrowLeft } from "lucide-react";
import Image from "next/image";
import SignupStep1 from "../../public/images/signup1.png";
import Signup from "../../public/images/signup.png";
import Logo from "../../public/images/logo.png";
import BgImage from "../../public/images/bg.png"; // Background image
            ...
            <form onSubmit={handleNext} className="space-y-5 sm:space-y-6">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e) => handleChange("email", e.target.value)}
                  placeholder="hellonexample@gmail.com"
                  className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-white/10 backdrop-blur-md border ${
                    errors.email ? "border-red-500" : "border-white/20"
                  } rounded-lg text-sm sm:text-base text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-[#FFF312] focus:border-transparent transition-all`}
                />
                {errors.email && (
                  <p className="text-red-500 text-xs mt-1">{errors.email}</p>
                )}
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    } rounded-lg text-sm sm:text-base text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-[#FFF312] focus:border-transparent transition-all pr-10 sm:pr-12`}
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
            ...
            <form onSubmit={handleSignup} className="space-y-5 sm:space-y-6">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-white/10 backdrop-blur-md border ${
                    errors.dateOfJoining ? "border-red-500" : "border-white/20"
                  } rounded-lg text-sm sm:text-base text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-[#FFF312] focus:border-transparent transition-all`}
                />
                {errors.dateOfJoining && (
                  <p className="text-red-500 text-xs mt-1">
              ...
              <div className="flex gap-3">
                ...
                <button
                  type="button"
                  onClick={handleBack}
                  className="w-1/3 py-3.5 bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/20 cursor-pointer text-white font-bold rounded-lg transition-all duration-300 flex items-center justify-center gap-2"
                >
                  <ArrowLeft size={20} />
                  Back
                </button>
